...
import ua.com.CollectionsAndMap.domain.MainActivity;
import ua.com.CollectionsAndMap.utils.FillView;

public class AsyncFill extends AsyncTask<Void,Void,Void> {
    private   int fragmentNumbr;
    private ViewPager viewPager;
    private int amountElements;
    Context context;
    AlertDialog showProgress;

    public AsyncFill(ViewPager viewPager,int amountElements) {
        this.viewPager = viewPager;
        this.fragmentNumbr = viewPager.getCurrentItem();
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        showProgress = new AlertDialog.Builder(context)
